...
const MainPage = () => {
  const { todos, toggleTodo, deleteTodo, addTodo, changeDescription } =
    useTodo();
  ...
  return (
    <div className={'mainContainer'}>
      <div className={'mainContainer__header'}>
        ...
        <div className={'mainContainer__header__topBox'}>
          ...
          <button
            ...
            className={'mainContainer__header__topBox__addTask'}
          >
      ...
      <div className={'mainContainer__headerButtonsBox'}>
        <button
          onClick={getAllTodos}
          className={'mainContainer__headerButtonsBox__topButtons'}
        >
          Все
        </button>
        <button
          ...
          filteredTodos.map((item) => {
            return (
              <div
                key={item.id}
                className={
                  item.completed && editId !== item.id
                    ? 'mainContainer__todos__todoComplited'
                    : 'mainContainer__todos__todo'
                }
              >
                {editId === item.id ? (
                  <>
            ...
            <div className={'modalWindowDelete'}>
              ...
              <div className={'modalWindowDelete__boxButtons'}>
                <button
                  ...
                  className={'modalWindowDelete__boxButtons__oneButton'}
                >
                  Да
                </button>
                <button
      ...
      <div className={'mainContainer__bottomBox'}>
        <button
          ...
          className={'mainContainer__bottomBox__buttonsBot'}
        >
          Удалить выполненые заметки
        </button>
        <button
